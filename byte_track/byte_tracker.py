...
from byte_track import matching
from byte_track.basetrack import BaseTrack, TrackState
...
class BYTETracker(object):
    ...
    def update(self, output_results, img_info, img_size):
        ...
        #output_stracks += [track for track in self.lost_stracks if track.is_activated]
